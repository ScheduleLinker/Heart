import json
from uuid import uuid4 #generates random Universally Unique Identifier

"""
This file defines a TempStorage class for temporarily storing data in a JSON file.
"""
...
class TempStorage:
    ...
    def read(self, session_uid: str) -> dict | None:
        return self.__storage.get(session_uid)

    def update_storage(self, session_uid: str, updates: dict) -> bool:
